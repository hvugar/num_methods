...
class Parabolic1DControl35 : public IParabolicEquation, public IBackwardParabolicEquation, public RnFunction, public IGradient, public IPrinter
{
public:
    Parabolic1DControl35();
    virtual ~Parabolic1DControl35() {}
