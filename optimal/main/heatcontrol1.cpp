...
void HeatGradientMethod1::calculateGradient()
{
...
double HeatControl1::u(double x, double t)
{
    return x*x + t*t + 2.0*x;
}

double HeatControl1::U(double x) const
{
    return x*x + 2.0*x + 1.0;
}

double HeatControl1::F(double x, double t)
{
   return 2.0*t - 2.0;
}

double HeatControl1::m1(double t)
{
    return t*t;
}

double HeatControl1::m2(double t)
{
    return t*t + 3.0;
}

double HeatControl1::fi(double x)
{
    return x*x + 2.0*x;
}

void HeatControl1::calculate()
{

}

double HeatControl1::fxt1(double x, double t)
{
...
void HeatControl1::gradient(DoubleVector &g) const
{
}
