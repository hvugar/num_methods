...
//    return;
    ...
    IGradient::Gradient(&p22d5, 0.020, pv, ng, 2*rpm.Lc*rpm.Lo+0*Lc,     2*rpm.Lc*rpm.Lo+2*rpm.Lc-1);
    IGradient::Gradient(&p22d5, 0.001, pv, ng, 2*rpm.Lc*rpm.Lo+2*rpm.Lc, 2*rpm.Lc*rpm.Lo+2*rpm.Lc+2*rpm.Lo-1);
