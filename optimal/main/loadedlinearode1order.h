...
protected:
    ...
    virtual double C(const GridNodeODE &node, unsigned int s, unsigned int row = 0, unsigned int col = 0) const;

public:
    double x(const GridNodeODE &node, unsigned int num) const;
};
