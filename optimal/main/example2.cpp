...
//        x.at(i) = 0.1*i;
    ...
    beta.at(0,0) = +0.2; beta.at(0,1) = -0.1;
    beta.at(1,0) = +0.3; beta.at(1,1) = +0.4;
    //beta.at(1,200) = 1.0; beta.at(1,400) = +3.0; beta.at(1,N-1) = -2.0; beta.at(1,N) = 1.0;

    DoubleVector qamma(K);
    qamma.at(0) = beta.at(0,0)*x.at(0) + beta.at(0,1)*x.at(1);
    qamma.at(1) = beta.at(1,0)*x.at(0) + beta.at(1,1)*x.at(1);
    //qamma[1] = beta.at(1,200)*x[200] + beta.at(1,400)*x[400] + beta.at(1,N-1)*x[N-1] + beta.at(1,N)*x[N];
...
//    for (unsigned int i=0; i<K; i++) b.at(i) = qamma.at(i);
    ...
    x1.at(1) = b1/a1;
    printf("%14.20f %14.20f\n", b1, a1);
    x1.at(0) = -(m.at(0,1)/m.at(0,0))*x1.at(1) + b.at(0)/m.at(0,0);

    printf("x1 %14.10f %14.10f\n", x1.at(0), x1.at(1));
    printf("x0 %14.10f %14.10f\n", x0.at(N-1), x0.at(N));
