...
void CFunction1::gradient(const DoubleVector& u, DoubleVector &g)
{
    DoubleVector x(2);
    DoubleVector psi(2);
    calculate_x(u);
...
void CFunction1::print(unsigned int i, const DoubleVector& u, const DoubleVector &g, double alpha, RnFunction* f) const
{
    C_UNUSED(g);
    C_UNUSED(alpha);
    printf("J[%2d]: %.10f  ", i, f->fx(u));
