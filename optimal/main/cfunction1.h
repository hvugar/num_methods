...
struct CFunction1 : public RnFunction
{
    ...
    double fx0(double t, std::vector<double> x, double u) const;
    double fx1(double t, std::vector<double> x, double u) const;
    double fx2(double t, std::vector<double> x, double u) const;
    ...
    virtual double fx(const DoubleVector& u) const;
