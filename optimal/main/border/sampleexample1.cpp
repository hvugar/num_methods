...
void SampleMain()
{
...

    {
        ...
        // 0.5
        A[6][0]  = a[0][0][0][60]; A[6][1]  = a[0][0][1][60]; A[6][2]  = a[0][0][2][60];
        ...
        A[7][0]  = a[0][1][0][60]; A[7][1]  = a[0][1][1][60]; A[7][2]  = a[0][1][2][60];
        ...
        A[8][0]  = a[0][2][0][60]; A[8][1] = a[0][2][1][60];  A[8][2]  = a[0][2][2][60];
        ...
        A[11][0]  = a[0][2][0][90]; A[11][1] = a[0][2][1][90];  A[11][2]  = a[0][2][2][90];
        ...
        // 1.0
        A[12][0]  = a[0][0][0][120]; A[12][1]  = a[0][0][1][120]; A[12][2]  = a[0][0][2][120];
        A[12][3]  = a[1][0][0][120]; A[12][4]  = a[1][0][1][120]; A[12][5]  = a[1][0][2][120];
        A[12][9]  = a[2][0][0][120]; A[12][7]  = a[2][0][1][120]; A[12][8]  = a[2][0][2][120];
        A[12][12]  = b[0][0][0][120]; A[12][10] = b[0][0][1][120]; A[12][11] = b[0][0][2][120];
        A[12][12] = b[1][0][0][120]; A[12][13] = b[1][0][1][120]; A[12][14] = b[1][0][2][120];

        A[13][0]  = a[0][1][0][120]; A[13][1]  = a[0][1][1][120]; A[13][2]  = a[0][1][2][120];
        A[13][3]  = a[1][1][0][120]; A[13][4]  = a[1][1][1][120]; A[13][5]  = a[1][1][2][120];
        ...
        A[14][0]  = a[0][2][0][120]; A[14][1] = a[0][2][1][120];  A[14][2]  = a[0][2][2][120];
        A[14][3]  = a[1][2][0][120]; A[14][4] = a[1][2][1][120];  A[14][5]  = a[1][2][2][120];
