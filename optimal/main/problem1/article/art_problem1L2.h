...
class ArtProblem1L2 : /*protected RnFunction, protected IGradient,*/ public IPrinter, public IProjection, public IProblem1
{
public:
    ArtProblem1L2();
...
//    virtual void calculateP(DoubleMatrix &p, const DoubleMatrix &u, const DoubleVector &k, const DoubleVector &z, const DoubleVector &e);
...
//    virtual double delta(unsigned int n, const DoubleVector &e, unsigned int i) const;
