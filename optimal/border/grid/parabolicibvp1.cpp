...
{
    ParabolicIBVP1 p;
    p.setTimeDimension(Dimension(0.0001, 10000, 0000));
    p.addSpaceDimension(Dimension(0.01, 100, 0000));
    {
...
#endif
#ifdef SAMPLE_6
    return 2.0*sin(20.0*x)*cos(10.0*x) + 200.0*t*a(sn,tn)*(5.0*sin(20.0*x)*cos(10.0*x)+4.0*cos(20.0*x)*sin(10.0*x));
#endif
}
