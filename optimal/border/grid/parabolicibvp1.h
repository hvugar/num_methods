...
protected:
    ...
    virtual double initial(unsigned int i UNUSED_PARAM, unsigned int j UNUSED_PARAM) const { return 0.0; }
    virtual double boundary(unsigned int i UNUSED_PARAM, unsigned int j UNUSED_PARAM, unsigned int k UNUSED_PARAM) const  { return 0.0; }
    virtual double f(unsigned int i UNUSED_PARAM, unsigned int j UNUSED_PARAM, unsigned int k UNUSED_PARAM) const  { return 0.0; }
    virtual double a(unsigned int i UNUSED_PARAM, unsigned int j UNUSED_PARAM, unsigned int k UNUSED_PARAM) const  { return 1.0; }
