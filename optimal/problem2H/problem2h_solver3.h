#ifndef PROBLEM2H_SOLVER3_H
#define PROBLEM2H_SOLVER3_H

#include "problem2h_common.h"

class PROBLEM2HSHARED_EXPORT Problem2HNDirichlet3 : public RnFunction, public IGradient, public InitialBoundaryValueProblemPDE, public IProjection, public IPrinter, public IVectorNormalizer
{
public:
    static void Main(int argc, char* argv[]);
    static void checkGradient1(const Problem2HNDirichlet3 &prob);
    static void checkGradient2(const Problem2HNDirichlet3 &prob);

    Problem2HNDirichlet3();
    virtual ~Problem2HNDirichlet3();
