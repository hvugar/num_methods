...
class PROBLEM2HSHARED_EXPORT Problem2HNDirichlet2 : public RnFunction, public IGradient, public InitialBoundaryValueProblemPDE, public IProjection, public IPrinter, public IVectorNormalizer
{
public:
    static void Main(int argc, char* argv[]);
    static void checkGradient1(const Problem2HNDirichlet2 &prob);
    static void checkGradient2(const Problem2HNDirichlet2 &prob);

    Problem2HNDirichlet2();
    virtual ~Problem2HNDirichlet2();
