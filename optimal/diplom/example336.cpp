...
Parabolic1DControl336::Parabolic1DControl336()
{
    alpha = 1.0;
...
double Parabolic1DControl336::fx(const DoubleVector& x)
{
    px = &x;
    DoubleMatrix u;
    IParabolicEquation2D::caluclateMVD(u, h1, h2, ht, N1, N2, M, a1, a2);
...
double Parabolic1DControl336::norm(const DoubleVector& v) const
{
    double nrm = 0.0;
...
void Parabolic1DControl336::gradient(const DoubleVector& x, DoubleVector& g)
{
    px = &x;
    DoubleMatrix u;
    IParabolicEquation2D::caluclateMVD(u, h1, h2, ht, N1, N2, M, a1, a2);
...
void Parabolic1DControl336::calculateGX(const DoubleVector& x, const DoubleMatrix& psi, DoubleVector& g, unsigned int k)
{
    double psiX1;
    double psiX2;
    if (k==1 || k==M)
...
void Parabolic1DControl336::psiDerivative(double &psiX1, double &psiX2, double x1, double x2, const DoubleMatrix &psi)
{
...
double Parabolic1DControl336::bfi(unsigned int i, unsigned int j) const
{
    return -2.0*((*pu)[j][i] - U[j][i]);
}

double Parabolic1DControl336::bm1(unsigned int j, unsigned int k) const
{
    C_UNUSED(j);
    C_UNUSED(k);
    return 0.0;
...
double Parabolic1DControl336::bm2(unsigned int j, unsigned int k) const
{
    C_UNUSED(j);
    C_UNUSED(k);
    return 0.0;
...
double Parabolic1DControl336::bm3(unsigned int i, unsigned int k) const
{
    C_UNUSED(i);
    C_UNUSED(k);
    return 0.0;
...
double Parabolic1DControl336::bm4(unsigned int i, unsigned int k) const
{
    C_UNUSED(i);
    C_UNUSED(k);
    return 0.0;
...
double Parabolic1DControl336::bf(unsigned int i, unsigned int j, unsigned int k) const
{
    C_UNUSED(i);
    C_UNUSED(j);
    C_UNUSED(k);
...
void Parabolic1DControl336::print(unsigned int i, const DoubleVector& x, const DoubleVector &g, double alpha, RnFunction* fn) const
{
    C_UNUSED(alpha);
    Parabolic1DControl336 *hc = dynamic_cast<Parabolic1DControl336*>(fn);
    printf("J[%d]: %.16f\n", i, hc->fx(x));
    DoubleVector g1 = g;
    g1.L2Normalize();
    printf("eo: [%12.8f, %12.8f] [%12.8f, %12.8f] [%12.8f, %12.8f]\n", 0.50, 0.80, 0.70, 0.20, 0.20, 0.30);
...
void Parabolic1DControl336::project(DoubleVector &e, int index)
{
    if (index<6)
    {
