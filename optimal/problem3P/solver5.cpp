...
//    const_cast<Functional*>(this)->drawImages = false;
    ...
    printf("I[%3d]: %10.6f | %10.6f %10.6f | %10.6f %10.6f | %10.6f | %4zu | %4zu | %4zu | %4zu \n", iteration, f, U.min(), U.max(),
           gm->min_step, gm->min_epsilon, alpha, functionCount,
           gm->search_function_count, gm->golden_function_count, gm->total__function_count);
    ...
    if (iteration!=0) const_cast<Functional*>(this)->gm->setR1MinimizeEpsilon(alpha*0.5, alpha*0.5);
