...
public:
    ...
    const double NORM_1[28] = {  0.7032, 0.5591,-2.0410,-0.9534, 1.0214,-0.1430,-2.0166, 0.2478,  0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,   -2.1284,-1.4006,   0.2439,0.3608,0.5999,0.7879 }; /*0.008712*/
