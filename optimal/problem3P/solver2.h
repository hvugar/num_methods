...
public:
    ...
    const double VCTR_2[28] = {
        1.8308, 0.7776, 0.4642,-3.8820,-0.7526, 1.6451,-0.0113,- 1.2315,
        0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000,  0.0000,
        5.2665, 4.9030, 5.3094, 5.1119, 4.9485, 4.8194, 5.2899,  5.5338,
        0.2439, 0.3608, 0.5999, 0.7879
    };  /*0.00110691*/
