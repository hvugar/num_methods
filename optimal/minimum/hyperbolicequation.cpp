...
/*
void IHyperbolicEquation::calculateU(DoubleVector& u, unsigned int M, unsigned int N, double t0, double t1, double x0, double x1, double a, double lamda) const
{
    double ht = (t1 - t0) / M;
    double hx = (x1 - x0) / N;
...
void IHyperbolicEquation::calculateU(DoubleMatrix& u, unsigned int M, unsigned int N, double t0, double t1, double x0, double x1, double a, double lamda) const
{}

void IHyperbolicEquation::calculateP(DoubleVector &u, unsigned int M, unsigned int N, double t0, double t1, double x0, double x1, double a, double lamda) const
{}
