...
//void IHyperbolicEquation::calculateU2(DoubleMatrix &u, double hx, double ht, unsigned int M, unsigned int N, double a, double lamda) const
//{
//    for (unsigned int i=0; i<u.size(); i++) u[i].clear();
//    u.clear();
...
//void IHyperbolicEquation::calculateU2(DoubleVector &u, double hx, double ht, unsigned int M, unsigned int N, double a, double lamda) const
//{
//    u.clear();
//    u.resize(N+1);
...
//void IBackwardHyperbolicEquation::calculateU2(DoubleMatrix &p, double hx, double ht, unsigned int M, unsigned int N, double a, double lamda) const
//{
//    for (unsigned int i=0; i<p.size(); i++) p[i].clear();
//    p.clear();
...
//void IBackwardHyperbolicEquation::calculateU2(DoubleVector &p, double hx, double ht, unsigned int M, unsigned int N, double a, double lamda) const
//{
//    p.clear();
//    p.resize(N+1);
