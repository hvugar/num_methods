...
struct MINIMUMSHARED_EXPORT IPrinter
{
    ...
    static void printVector(const DoubleVector &x, short d, short e, const char *s = NULL, unsigned int n = 10, unsigned int start = 0, unsigned int end = 0, FILE *file = stdout);
