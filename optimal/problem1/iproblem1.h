...
protected:
    ...
    virtual void print(unsigned int i, const DoubleVector &y, const DoubleVector &g, double fx, double alpha, GradientBasedMethod::MethodResult result) const;
    ...
    virtual void calculateU3(DoubleMatrix &u, const DoubleVector &k, const DoubleVector &z, const DoubleVector &e) const;
